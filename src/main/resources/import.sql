...
Insert into book (id, isbn, publisher, title) values (3, '4567-896-07', 'Oxford University Press', 'Hamlet');
Insert into book (id, isbn, publisher, title) values (4, '4567-896-44', 'Oxford University Press', 'Fantastic night');
...
Insert into book_copy (id, library_num, date_of_borrowing, book_id) values (5, '4597-0987-cm', '2019-07-07', 2);
Insert into book_copy (id, library_num, date_of_borrowing, book_id) values (6, '4597-0987-cu', '2019-07-07', 3);
Insert into book_copy (id, library_num, date_of_borrowing, book_id) values (7, '4597-0987-oo', '2019-07-07', 4);

Insert into author (id, name) values (1, 'Julian Barnes');
Insert into author (id, name) values (2, 'Luiggi Pirandelo');
Insert into author (id, name) values (3, 'Milos Crnjanski');
